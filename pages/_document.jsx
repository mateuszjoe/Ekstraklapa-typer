...
export default function Document() {
  return (
    <Html lang="pl" className="app-loading">
      <Head>
        <link rel="icon" type="image/png" sizes="32x32" href="/assets/brand/favicon-32.png?v=5" />
        <link rel="apple-touch-icon" sizes="180x180" href="/assets/brand/apple-touch-icon.png?v=5" />
        <link rel="manifest" href="/manifest.webmanifest?v=5" />
        <link rel="preload" as="image" href="/assets/brand/app-icon-192.png?v=5" />
      ...
      <body>
        <div id="appLoader" role="status" aria-live="polite" aria-label="Wczytywanie Ekstraklasa Typer">
          <div className="loader-card">
            <div className="loader-emblem"><img src="/assets/brand/app-icon-192.png?v=5" width="88" height="88" alt="" /></div>
